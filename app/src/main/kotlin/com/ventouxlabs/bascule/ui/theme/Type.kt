...
/**
 * Material3's default type scale against the system font — no custom font
 * asset exists in this repo, and the platform default (Roboto Flex on recent
 * Android) already reads cleanly at every size in this scale.
 */
val BasculeTypography = Typography(
